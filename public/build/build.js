...
},{"flux":2,"react/lib/Object.assign":30}],163:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
window.onload = function() {
  React.render(React.createElement(Articles, {url: "/api/blog", pollInterval: 10000}), document.body);
}
},{"./articles":166,"react":159}],164:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
...
},{"../vendor/form-for/form-for.react":175,"react":159}],165:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
...
},{"../actions/article-actions":160,"../stores/article-store":167,"./article-form":164,"react":159}],166:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
...
var Articles = React.createClass({displayName: "Articles",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "articles"}, 
        React.createElement("div", {className: "articles-search"}, 
         React.createElement("label", {className: "ps-frm-lbl"}, "Search:"), " ", React.createElement("input", {type: "text", placeholder: "search", className: "ps-frm-entry", onKeyUp: this.filter})
        ), 
        React.createElement("div", {className: "articles-list", id: "articles-list"}, 
          this.renderArticles()
        ), 
        React.createElement("div", {className: "articles-form", id: "articles-form"}, 
         React.createElement("label", {className: "ps-frm-lbl"}, "Form template:"), 
          this.renderForm()
        )
      )
    );
  ...
  renderArticles: function() {
    ...
    this.state.articles.forEach(function(article) {
      articles.push(React.createElement(Article, {key: article.id, article: article, errors: this.state.errors, handleEdit: this.handleEdit, handleDelete: this.handleDelete}));
    }.bind(this));
    return articles;
  },
  renderForm: function() {
    ...
    return(React.createElement(ArticleForm, {object: object, options: options, errors: this.state.errors}));
  },
...
},{"../actions/article-actions":160,"../stores/article-store":167,"../utils/loadJson":168,"./article":165,"./article-form":164,"react":159}],167:[function(require,module,exports){
var ArticleDispatcher = require('../dispatchers/article-dispatcher');
var ArticleConstants = require('../constants/article-constants');
var Utils = require('../utils/loadJson');
...
},{"../constants/article-constants":161,"../dispatchers/article-dispatcher":162,"../utils/loadJson":168}],168:[function(require,module,exports){
var Utils = {
...
var DatetimeInput = React.createClass({displayName: "DatetimeInput",
  render: function() {
    var data = this.props.data;
    return (
      React.createElement("input", {ref: data.name, type: "datetime", defaultValue: data.defaultValue, className: data.className})
    );
  }
...
module.exports = FormFor = React.createClass({displayName: "FormFor",
  ...
  submitText: function() {
    ...
    submit = this.props.object.id ? 'update' : 'add';
...
},{"./form-errors.react":174,"./input.react":177,"react":159}],176:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
...
},{"./checkbox-input.react":169,"./color-input.react":170,"./date-input.react":171,"./datetime-input.react":172,"./email-input.react":173,"./hidden-input.react":176,"./number-input.react":178,"./password-input.react":180,"./select-input.react":181,"./text-input.react":182,"./textarea-input.react":183,"react":159}],178:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
...
},{"./options-for-select.react":179,"react":159}],182:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
var React = require('react');
